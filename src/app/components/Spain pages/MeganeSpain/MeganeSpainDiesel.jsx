      ...
      <section className=" border rounded-md">
        <div className="">
          <div className="">
                  ...
                  <div className="mt-2">
                    <div className="px-4 mb-2">
                      ...
                      <h1 className="text-[15px]">
                        Calculateur Renault Mégane 3 - 1.5 Diesel
                      </h1>
                    </div>
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[15px]">
                        Module de commande (calculateur) Renault Mégane 3 Diesel
                      </p>
                    </div>
                    <div className="px-4 mb-3">
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[15px]">Mégane 3 - 1.5 Diesel</p>
                    </div>
                    <div className="px-4 mb-3">
                ...
                <div className="md:flex md:px-5 px-4 py-1 justify-between">
                  <div className="md:w-1/2 flex items-center gap-5">
                    ...
                    <div className="">
                      ...
                      <h1 className="my-1">Mégane 3 - 1.5 Diesel</h1>
                    </div>
                  </div>
                    ...
                    <div className="text-center">
                      {stock === 0 ? (
                        ...
                        <button
                          onClick={() =>
                            document
                              .getElementById("ModalMeganeDiesel")
                              .showModal()
                          }
                      ...
                      {/* <button
                        onClick={() =>
                          document.getElementById("ModalMeganeDiesel").showModal()
                        }
                        className=" bg-[#2C80EF] text-white rounded-md text-center border border-[#2C80EF] py-2 px-5 shadow-2xl hover:text-[#fff] hover:bg-[#2c80efd7] text-[15px] md:my-0 my-5"
                      >
                        Commander
            ...
            {/* MODAL */}
            <dialog id="ModalMeganeDiesel" className="modal">
...
export default MeganeSpainDiesel;
