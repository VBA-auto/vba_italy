      ...
      <section className=" border rounded-md">
        <div className="">
          <div className="">
                    ...
                    <div className="text-center">
                      {stock === 0 ? (
                        ...
                        <button
                          onClick={() =>
                            document
                              .getElementById("ModalClioRsEssence")
                              .showModal()
                          }
                      ...
                      {/* <button
                        onClick={() =>
                          document.getElementById("ModalClioRsEssence").showModal()
                        }
                        className=" bg-[#2C80EF] text-white rounded-md text-center border border-[#2C80EF] py-2 px-5 shadow-2xl hover:text-[#fff] hover:bg-[#2c80efd7] text-[15px] md:my-0 my-5"
                      >
                        Commander
            ...
            {/* MODAL */}
            <dialog id="ModalClioRsEssence" className="modal">
...
export default CliorsSpainEseence;
