...
import FluenceModal from "./FluenceModal";
  ...
  return (
    <>
      <div
        className=""
        onClick={() =>
          document.getElementById("ModalSpainFluenceParent").showModal()
        }
      >
      ...
      <dialog id="ModalSpainFluenceParent" className="modal ">
