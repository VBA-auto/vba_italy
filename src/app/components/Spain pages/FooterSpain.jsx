        ...
        <footer className="myFooter bg-[#ffffff] border-[#c9c9c9] text-black py-4">
          <div className="xl:flex flex-wrap justify-between gap-4">
            ...
            <div className="text-center footerMid">
              <div>
                <Link
                  href="https://laboiteautomatique.com/produits"
                  className="hover:text-[#2C80EF] text-[15px]"
                >
                  Prodotti -
                </Link>
                <Link
                  href="https://laboiteautomatique.com/prestation/installation"
                  className="hover:text-[#2C80EF] text-[15px]"
                >
                  {" "}
                  Installazione -
                ...
                <Link
                  href="https://laboiteautomatique.com/contact"
                  className="hover:text-[#2C80EF] text-[15px]"
                >
                  {" "}
                  Contatto -
                ...
                <Link
                  href="https://laboiteautomatique.com/selectionnez-votre-vehicule"
                  className="hover:text-[#2C80EF] text-[15px]"
                >
                  {" "}
                  Disponibilità
              ...
              <div className="pt-5 text-[15px]">
                <Link
                  href="https://laboiteautomatique.com/mentions-legales"
                  className="hover:text-[#2C80EF]"
                >
                  Mentions Légales
                </Link>
                <span> | </span>
                <Link
                  href="https://laboiteautomatique.com/sitemap"
                  className="hover:text-[#2C80EF]"
                >
                  Sitemap
                </Link>
